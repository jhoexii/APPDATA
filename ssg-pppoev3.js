            ...
            var observerSrTxt = new MutationObserver(function (mutations) {
                ...
                if (srVal != "") {
                    ...
                    $("#license-features")
                        .parents()
                        .eq(7)
                        .attr("id", "license-features-parents");
                    $("#license-features-parents .modal-footer .btn-danger")
                        .trigger("click");
                    $("#license-features-parents")
                        .next('div')
                        .hide()
                        .remove();
                    $("#license-features-parents")
...
function _x001() {
    if ($("#remove-file-ssgpppoejs")
        .length) {
        $("#remove-file-ssgpppoejs")
            .trigger("click");
    }

    $("textarea")
        .on("change input load", function () {
    ...
    function LogoBannerHeightFunc() {
        $("#LogoBannerHeight")
            .on("input change paste", function () {
                if (/^0+$/.test($(this)
                    ...
                    $("#LogoBannerHeight")
                        .val(LogoBannerHeight);
                    changeHeight();
                } else {
                    LogoBannerHeight = $(this)
                        .val();
                    changeHeight();
                }
            });
        ...
        function changeHeight() {
            $("#LogoBannerFilePreview")
                .css("max-height", LogoBannerHeight + "px")
    ...
    function LogoBannerCheckFunc() {
        if (!LogoBannerFile) {
            $("#LogoBannerFilePreview")
                .attr('src', "")
                .hide();
            $("#LogoBannerFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload Logo or Banner');
        } else {
            $("#LogoBannerFilePreview")
                .attr('src', backUpFile + LogoBannerFile + TimeStamp)
                .show();
            $("#LogoBannerFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + LogoBannerFile);
        }
    }
    ...
    function BrandTitleBackgroundFunc() {
        $("#BrandTitleBackGround-Picker, #BrandTitleBackGroundOpacity")
            .on("input change", function () {
                BrandTitleBackgroundOpacityColor();
            })

        function BrandTitleBackgroundOpacityColor() {
            var percentage = Math.floor($("#BrandTitleBackGroundOpacity")
                .val() * 100);
            $("#BrandTitleBackGroundOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#BrandTitleBackGround-Picker')
                .val();
            var alpha = $('#BrandTitleBackGroundOpacity')
                .val();
            ...
            $("#BrandTitleBackGround-Label")
                .css("background", BrandTitleBackground)
                .css("text-shadow", "0 0 5px #000");
        }
    }

    function BrandTitleBrdrFunc() {
        $("#BrandTitleBrdr-Picker, #BrandTitleBrdrOpacity")
            .on("input change", function () {
                BrandTitleBrdrOpacityColor();
            })

        function BrandTitleBrdrOpacityColor() {
            var percentage = Math.floor($("#BrandTitleBrdrOpacity")
                .val() * 100);
            $("#BrandTitleBrdrOpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#BrandTitleBrdr-Picker')
                .val();
            var alpha = $('#BrandTitleBrdrOpacity')
                .val();
            ...
            $("#BrandTitleBackGround-Label")
                .css("border", "solid 1px " + BrandTitleBrdr)
                .css("text-shadow", "0 0 5px #000");
        }
    }
        ...
        $("#BrandTitle")
            .on("change", function () {
                if ($(this)
                    .is(":checked")) {
                    BrandTitle = true;
                    $("#BrandTitle-Container, #BrandTitleTextFXContainer, #subbrandtitleDiv")
                        .show();
                    $("head")
                        .append("<style id='animationText'>@keyframes animated_text{0%{background-position-x:0}100%{background-position-x:10000px}}</stye>")
                } else {
                    BrandTitle = false;
                    $("#BrandTitle-Container, #BrandTitleTextFXContainer,#subbrandtitleDiv")
                        .hide();
        ...
        $("#SubBrandTitle")
            .on("change", function () {
                if ($(this)
                    .is(":checked")) {
                    SubBrandTitle = true;
                    $("#SubBrandTitle-Container, #SubBrandTitleTextFXContainer")
                        .show();
                } else {
                    SubBrandTitle = false;
                    $("#SubBrandTitle-Container, #SubBrandTitleTextFXContainer")
    ...
    function BrandTitleTextAnimation() {
        $("#BrandTitleText")
            .attr("style", "background:linear-gradient(to left, " + fx1BrandTitle + ", " + fx2BrandTitle + ", " + fx3BrandTitle + ", " + fx4BrandTitle + ", " + fx5BrandTitle + ", " + fx6BrandTitle + ");background-size:300%;background-clip: text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;font-family: 'SSG';font-size: 30px!important;line-height: 1;");
        if (BrandTitleFX) {
            $('#BrandTitleText')
                .css({
    ...
    function MainBgFunc() {
        $('input[name="MainBgSettings"]')
            .on('change', function () {
                if ($('#MainBg-Image')
                    .is(':checked')) {
                    MainBgImage = true;
                    $("#MainBGFile-Container")
                        .show();
                    $("#MainBGColor-Container")
                        .hide();

                } else if ($('#MainBg-Color')
                    .is(':checked')) {
                    MainBgImage = false;
                    $("#MainBGFile-Container")
                        .hide();
    ...
    function MainBgImageFileCheckFunc() {
        if (!MainBgImageFile) {
            $("#MainBgFilePreview")
                ...
                .hide();
            $("#MainBgFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload Main Background');
        } else {
            $("#MainBgFilePreview")
                .attr('src', backUpFile + MainBgImageFile + TimeStamp)
                .show();
            $("#MainBgFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + MainBgImageFile);
        }
    }
    ...
    function PortalBgFunc() {
        $('input[name="PortalBgSettings"]')
            .on('change', function () {
                if ($('#PortalBg-Image')
                    .is(':checked')) {
                    PortalBgImage = true;
                    $("#PortalBgFile-Container")
                        .show();
                    $("#PortalBgColor-Container")
                        .hide();
                } else if ($('#PortalBg-Color')
                    .is(':checked')) {
                    PortalBgImage = false;
                    $("#PortalBgFile-Container")
                        .hide();
    ...
    function PortalBgImageFileCheckFunc() {
        if (!PortalBgImageFile) {
            $("#PortalBgFilePreview")
                ...
                .hide();
            $("#PortalBgFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload Portal Background');
        } else {
            $("#PortalBgFilePreview")
                .attr('src', backUpFile + PortalBgImageFile + TimeStamp)
                .show();
            $("#PortalBgFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + PortalBgImageFile);
        }
    }
    ...
    function PortalBgColorFunc() {
        $("#PortalBgColor-Picker1, #PortalBG1Opacity")
            .on("input change", function () {
                PortalBG1OpacityColor();
            });

        function PortalBG1OpacityColor() {
            var percentage = Math.floor($("#PortalBG1Opacity")
                .val() * 100);
            $("#PortalBG1Opacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#PortalBgColor-Picker1')
                .val();
            var alpha = $('#PortalBG1Opacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            PortalBgColor = rgbaColor;
            $("#PortalBgColor-Label")
                .css("background", PortalBgColor)
                .css("text-shadow", "0 0 5px #000");
        }
    }

    function PortalBgColorBorderFunc() {
        $("#PortalBgColorBorder-Picker, #PortalBgColorBorderOpacity")
            .on("input change", function () {
                PortalBgColorBorderOpacityColor();
            })

        function PortalBgColorBorderOpacityColor() {
            var percentage = Math.floor($("#PortalBgColorBorderOpacity")
                .val() * 100);
            $("#PortalBgColorBorderOpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#PortalBgColorBorder-Picker')
                .val();
            var alpha = $('#PortalBgColorBorderOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            PortalBgColorBorder = rgbaColor;
            $("#PortalBgColor-Label")
                .css("border", "solid 2px " + PortalBgColorBorder)
                .css("text-shadow", "0 0 5px #000");
        }
    }
    ...
    function ModalBgFunc() {
        $('input[name="ModalBgSettings"]')
            .on('change', function () {
                if ($('#ModalBg-Image')
                    .is(':checked')) {
                    ModalBgImage = true;
                    $("#ModalBgFile-Container")
                        .show();
                    $("#ModalBgColor-Container")
                        .hide();
                } else if ($('#ModalBg-Color')
                    .is(':checked')) {
                    ModalBgImage = false;
                    $("#ModalBgFile-Container")
                        .hide();
    ...
    function ModalBgImageFileCheckFunc() {
        if (!ModalBgImageFile) {
            $("#ModalBgFilePreview")
                ...
                .hide();
            $("#ModalBgFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload Modal Background');
        } else {
            $("#ModalBgFilePreview")
                .attr('src', backUpFile + ModalBgImageFile + TimeStamp)
                .show();
            $("#ModalBgFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + ModalBgImageFile);
        }
    }
    ...
    function ModalBgColorFunc() {
        $("#ModalBgColor-Picker1, #ModalBG1Opacity")
            .on("input change", function () {
                ModalBG1OpacityColor();
            });

        function ModalBG1OpacityColor() {
            var percentage = Math.floor($("#ModalBG1Opacity")
                .val() * 100);
            $("#ModalBG1Opacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#ModalBgColor-Picker1')
                .val();
            var alpha = $('#ModalBG1Opacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            ModalBgColor = rgbaColor;
            $("#ModalBgColor-Label")
                .css("background", ModalBgColor)
                .css("text-shadow", "0 0 5px #000");
        }
    }

    function ModalBgColorBorderFunc() {
        $("#ModalBgColorBorder-Picker, #ModalBgColorBorderOpacity")
            .on("input change", function () {
                ModalBgColorBorderOpacityColor();
            })

        function ModalBgColorBorderOpacityColor() {
            var percentage = Math.floor($("#ModalBgColorBorderOpacity")
                .val() * 100);
            $("#ModalBgColorBorderOpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#ModalBgColorBorder-Picker')
                .val();
            var alpha = $('#ModalBgColorBorderOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            ModalBgColorBorder = rgbaColor;
            $("#ModalBgColor-Label")
                .css("border", "solid 2px " + ModalBgColorBorder)
                .css("text-shadow", "0 0 5px #000");
        }
    }
    ...
    function StatsShowFunc() {
        $("#StatsActiveExpiredSwitch")
            .on("change", function () {
                if ($(this)
                    .is(":checked")) {
                    StatsShow = true;
                    $("#StatsActiveExpiredContent")
                        .show();
                } else {
                    StatsShow = false;
                    $("#StatsActiveExpiredContent")
    ...
    function activeTextInfoShowFunc() {
        $("#ActiveStatsInfoSwitch")
            .on("change", function () {
                if ($(this)
                    .is(":checked")) {
                    activeTextInfoShow = true;
                    $("#activeTextInfo-Container")
                        .show();
                } else {
    ...
    function activeTextInfoColorFunc() {
        $("#activeTextInfo-Picker")
            .on("input change", function () {
                $("#activeTextInfo-Label")
                    .css("color", $(this)
                        .val());
                activeTextInfoColor = $(this)
                    .val();
            });
    }
    ...
    function expiredTextInfoFunc() {
        $("#expiredTextInfo-Label")
            .on("input change", function () {
                expiredTextInfo = $(this)
                    .val();
            });
    }

    function expiredTextInfoColorFunc() {
        $("#expiredTextInfo-Picker")
            .on("input change", function () {
                $("#expiredTextInfo-Label")
                    .css("color", $(this)
                        .val());
                expiredTextInfoColor = $(this)
                    .val();
            });
    }
    ...
    function MessengerColorFunc() {
        $("#Messenger-Picker")
            .on("input change", function () {
                $("#Messenger-Label,#Messenger-Link")
                    .css("color", $(this)
                        .val());
                MessengerColor = $(this)
                    .val();
    ...
    function ContactNumberColorFunc() {
        $("#ContactNumber-Picker")
            .on("input change", function () {
                $("#ContactNumber-Label")
                    .css("color", $(this)
                        .val());
                ContactNumberColor = $(this)
                    .val();
            });
    }
    ...
    function ExtraHtmlCssCodeFunc() {
        $("#ExtraHtml-Label")
            .on("input change paste", function () {
                ExtraHtmlCssCode = $(this)
                    .val();
            })
    }

    function ExtraHtmlBackgroundFunc() {
        $("#ExtraHtmlBackGround-Picker, #ExtraHtmlBackGroundOpacity")
            .on("input change", function () {
                ExtraHtmlBGOpacityColor();
            })

        function ExtraHtmlBGOpacityColor() {
            var percentage = Math.floor($("#ExtraHtmlBackGroundOpacity")
                .val() * 100);
            $("#ExtraHtmlBackGroundOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#ExtraHtmlBackGround-Picker')
                .val();
            var alpha = $('#ExtraHtmlBackGroundOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            ExtraHtmlBackground = rgbaColor;
            $("#ExtraHtmlBackGround-Label")
                .css("background", ExtraHtmlBackground)
                .css("text-shadow", "0 0 5px #000");
        }
    }

    function ExtraHtmlBrdrFunc() {
        $("#ExtraHtmlBrdr-Picker, #ExtraHtmlBrdrOpacity")
            .on("input change", function () {
                ExtraHtmlBrdrOpacityColor();
            })

        function ExtraHtmlBrdrOpacityColor() {
            var percentage = Math.floor($("#ExtraHtmlBrdrOpacity")
                .val() * 100);
            $("#ExtraHtmlBrdrOpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#ExtraHtmlBrdr-Picker')
                .val();
            var alpha = $('#ExtraHtmlBrdrOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            ExtraHtmlBrdr = rgbaColor;
            $("#ExtraHtmlBackGround-Label")
                .css("border", "solid 1px " + ExtraHtmlBrdr)
                .css("text-shadow", "0 0 5px #000");
        }
    }
    ...
    function GcashQrCheckFunc() {
        if (!GcashQr) {
            $("#GcashFileParent")
                .attr('class', "ParentQR fa fa-qrcode");
            $("#GcashFilePreview")
                .attr('src', '')
                .hide();
            $("#GcashFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload Gcash Qr');
        } else {
            $("#GcashFileParent")
                .attr('class', "ParentQR");
            $("#GcashFilePreview")
                .attr('src', backUpFile + GcashQr + TimeStamp)
                .show();
            $("#GcashFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + GcashQr);
        }
    }
    ...
    function GcashBGFunc() {
        $("#GcashBG-Picker, #GcashOpacity")
            .on("input change", function () {
                GcashBGOpacityColor();
            });

        function GcashBGOpacityColor() {
            var percentage = Math.floor($("#GcashOpacity")
                .val() * 100);
            $("#GcashOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#GcashBG-Picker')
                .val();
            var alpha = $('#GcashOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            GcashBG = rgbaColor;
            $("#GcashBtn")
                .css("background", GcashBG)
                .css("text-shadow", "0 0 5px #000");
        }
    }

    function GcashBrdrFunc() {
        $("#GcashBRDR-Picker, #GcashBRDROpacity")
            .on("input change", function () {
                GcashBrdrOpacityColor();
            });

        function GcashBrdrOpacityColor() {
            var percentage = Math.floor($("#GcashBRDROpacity")
                .val() * 100);
            $("#GcashBRDROpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#GcashBRDR-Picker')
                .val();
            var alpha = $('#GcashBRDROpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            GcashBrdr = rgbaColor;
            $("#GcashBtn")
                .css("border", "solid 1px " + GcashBrdr)
                .css("text-shadow", "0 0 5px #000");
        }
    }
    ...
    function MayaQrCheckFunc() {
        if (!MayaQr) {
            ...
            $("#MayaFilePreview")
                ...
                .hide();
            $("#MayaFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload Maya Qr');
        } else {
            $("#MayaFileParent")
                .attr('class', "ParentQR");
            $("#MayaFilePreview")
                .attr('src', backUpFile + MayaQr + TimeStamp)
                .show();
            $("#MayaFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + MayaQr);
        }
    }
    ...
    function MayaBGFunc() {
        $("#MayaBG-Picker, #MayaOpacity")
            .on("input change", function () {
                MayaBGOpacityColor();
            });

        function MayaBGOpacityColor() {
            var percentage = Math.floor($("#MayaOpacity")
                .val() * 100);
            $("#MayaOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#MayaBG-Picker')
                .val();
            var alpha = $('#MayaOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            MayaBG = rgbaColor;
            $("#MayaBtn")
                .css("background", MayaBG)
                .css("text-shadow", "0 0 5px #000");
        }
    }

    function MayaBrdrFunc() {
        $("#MayaBRDR-Picker, #MayaBRDROpacity")
            .on("input change", function () {
                MayaBrdrOpacityColor();
            });

        function MayaBrdrOpacityColor() {
            var percentage = Math.floor($("#MayaBRDROpacity")
                .val() * 100);
            $("#MayaBRDROpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#MayaBRDR-Picker')
                .val();
            var alpha = $('#MayaBRDROpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            MayaBrdr = rgbaColor;
            $("#MayaBtn")
                .css("border", "solid 1px " + MayaBrdr)
                .css("text-shadow", "0 0 5px #000");
        }
    }
    ...
    function BPIQrCheckFunc() {
        if (!BPIQr) {
            ...
            $("#BPIFilePreview")
                ...
                .hide();
            $("#BPIFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload BPI Qr');
        } else {
            $("#BPIFileParent")
                .attr('class', "ParentQR");
            $("#BPIFilePreview")
                .attr('src', backUpFile + BPIQr + TimeStamp)
                .show();
            $("#BPIFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + BPIQr);
        }
    }
    ...
    function BPIBGFunc() {
        $("#BPIBG-Picker, #BPIOpacity")
            .on("input change", function () {
                BPIBGOpacityColor();
            });

        function BPIBGOpacityColor() {
            var percentage = Math.floor($("#BPIOpacity")
                .val() * 100);
            $("#BPIOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#BPIBG-Picker')
                .val();
            var alpha = $('#BPIOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            BPIBG = rgbaColor;
            $("#BPIBtn")
                .css("background", BPIBG)
                .css("text-shadow", "0 0 5px #000");
        }
    }

    function BPIBrdrFunc() {
        $("#BPIBRDR-Picker, #BPIBRDROpacity")
            .on("input change", function () {
                BPIBrdrOpacityColor();
            });

        function BPIBrdrOpacityColor() {
            var percentage = Math.floor($("#BPIBRDROpacity")
                .val() * 100);
            $("#BPIBRDROpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#BPIBRDR-Picker')
                .val();
            var alpha = $('#BPIBRDROpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            BPIBrdr = rgbaColor;
            $("#BPIBtn")
                .css("border", "solid 1px " + BPIBrdr)
                .css("text-shadow", "0 0 5px #000");
        }
    }
    ...
    function SpayQrCheckFunc() {
        if (!SpayQr) {
            ...
            $("#SpayFilePreview")
                ...
                .hide();
            $("#SpayFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload Spay Qr');
        } else {
            $("#SpayFileParent")
                .attr('class', "ParentQR");
            $("#SpayFilePreview")
                .attr('src', backUpFile + SpayQr + TimeStamp)
                .show();
            $("#SpayFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + SpayQr);
        }
    }
    ...
    function SpayBGFunc() {
        $("#SpayBG-Picker, #SpayOpacity")
            .on("input change", function () {
                SpayBGOpacityColor();
            });

        function SpayBGOpacityColor() {
            var percentage = Math.floor($("#SpayOpacity")
                .val() * 100);
            $("#SpayOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#SpayBG-Picker')
                .val();
            var alpha = $('#SpayOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            SpayBG = rgbaColor;
            $("#SpayBtn")
                .css("background", SpayBG)
                .css("text-shadow", "0 0 5px #000");
        }
    }

    function SpayBrdrFunc() {
        $("#SpayBRDR-Picker, #SpayBRDROpacity")
            .on("input change", function () {
                SpayBrdrOpacityColor();
            });

        function SpayBrdrOpacityColor() {
            var percentage = Math.floor($("#SpayBRDROpacity")
                .val() * 100);
            $("#SpayBRDROpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#SpayBRDR-Picker')
                .val();
            var alpha = $('#SpayBRDROpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            SpayBrdr = rgbaColor;
            $("#SpayBtn")
                .css("border", "solid 1px " + SpayBrdr)
                .css("text-shadow", "0 0 5px #000");
        }
    }
    ...
    function QRPHQrCheckFunc() {
        if (!QRPHQr) {
            ...
            $("#QRPHFilePreview")
                ...
                .hide();
            $("#QRPHFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload QRPH Qr');
        } else {
            $("#QRPHFileParent")
                .attr('class', "ParentQR");
            $("#QRPHFilePreview")
                .attr('src', backUpFile + QRPHQr + TimeStamp)
                .show();
            $("#QRPHFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + QRPHQr);
        }
    }
    ...
    function QRPHBGFunc() {
        $("#QRPHBG-Picker, #QRPHOpacity")
            .on("input change change", function () {
                QRPHBGOpacityColor();
            });

        function QRPHBGOpacityColor() {
            var percentage = Math.floor($("#QRPHOpacity")
                .val() * 100);
            $("#QRPHOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#QRPHBG-Picker')
                .val();
            var alpha = $('#QRPHOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            QRPHBG = rgbaColor;
            $("#QRPHBtn")
                .css("background", QRPHBG)
                .css("text-shadow", "0 0 5px #000");
        }
    }

    function QRPHBrdrFunc() {
        $("#QRPHBRDR-Picker, #QRPHBRDROpacity")
            .on("input change", function () {
                QRPHBrdrOpacityColor();
            });

        function QRPHBrdrOpacityColor() {
            var percentage = Math.floor($("#QRPHBRDROpacity")
                .val() * 100);
            $("#QRPHBRDROpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#QRPHBRDR-Picker')
                .val();
            var alpha = $('#QRPHBRDROpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            QRPHBrdr = rgbaColor;
            $("#QRPHBtn")
                .css("border", "solid 1px " + QRPHBrdr)
                .css("text-shadow", "0 0 5px #000");
        }
    }
    ...
    function OtherBankLogoCheckFunc() {
        if (!OtherBankLogo) {
            $("#OtherBankLogoBtn .img-btn")
                .attr('src', '')
                .hide();
            $("#OtherBankLogoDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload Other Bank Logo');
        } else {
            $("#OtherBankLogoBtn .img-btn")
                .attr('src', backUpFile + OtherBankLogo + TimeStamp)
                .show();
            $("#OtherBankLogoDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + OtherBankLogo);
        }
    }
    ...
    function OtherBankQrCheckFunc() {
        if (!OtherBankQr) {
            $("#OtherBankFileParent")
                .attr('class', "ParentQR fa fa-qrcode");
            $("#OtherBankFilePreview")
                .attr('src', '')
                .hide();
            $("#OtherBankFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i> Upload Other Bank Qr');
        } else {
            $("#OtherBankFileParent")
                .attr('class', "ParentQR");
            $("#OtherBankFilePreview")
                .attr('src', backUpFile + OtherBankQr + TimeStamp)
                .show();
            $("#OtherBankFileDisplay")
                .html('<i class="fa fa-upload" aria-hidden="true"></i>' + " " + OtherBankQr);
        }
    }
    ...
    function OtherBankBGFunc() {
        $("#OtherBankBG-Picker, #OtherBankOpacity")
            .on("input change change", function () {
                OtherBankBGOpacityColor();
            });

        function OtherBankBGOpacityColor() {
            var percentage = Math.floor($("#OtherBankOpacity")
                .val() * 100);
            $("#OtherBankOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#OtherBankBG-Picker')
                .val();
            var alpha = $('#OtherBankOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            OtherBankBG = rgbaColor;
            $("#OtherBankLogoBtn")
                .css("background", OtherBankBG)
                .css("text-shadow", "0 0 5px #000");
        }
    }

    function OtherBankBrdrFunc() {
        $("#OtherBankBRDR-Picker, #OtherBankBRDROpacity")
            .on("input change", function () {
                OtherBankBrdrOpacityColor();
            });

        function OtherBankBrdrOpacityColor() {
            var percentage = Math.floor($("#OtherBankBRDROpacity")
                .val() * 100);
            $("#OtherBankBRDROpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#OtherBankBRDR-Picker')
                .val();
            var alpha = $('#OtherBankBRDROpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            OtherBankBrdr = rgbaColor;
            $("#OtherBankLogoBtn")
                .css("border", "solid 1px " + OtherBankBrdr)
                .css("text-shadow", "0 0 5px #000");
        }
    }
        ...
        $("#PromoPlanCount")
            .on("change", function () {
                if ($(this)
                    .val() == "PromoPlan1") {
                    PromoCount = "1";
                    $("#PromoPlan1-Container")
                        .show();
                    $("#PromoPlan2-Container,#PromoPlan3-Container,#PromoPlan4-Container,#PromoPlan5-Container")
                        .hide();
                } else if ($(this)
                    .val() == "PromoPlan2") {
                    PromoCount = "2";
                    $("#PromoPlan1-Container,#PromoPlan2-Container")
                        .show();
                    $("#PromoPlan3-Container,#PromoPlan4-Container,#PromoPlan5-Container")
                        .hide();
                } else if ($(this)
                    .val() == "PromoPlan3") {
                    PromoCount = "3";
                    $("#PromoPlan1-Container,#PromoPlan2-Container,#PromoPlan3-Container")
                        .show();
                    $("#PromoPlan4-Container,#PromoPlan5-Container")
                        .hide();
                } else if ($(this)
                    .val() == "PromoPlan4") {
                    PromoCount = "4";
                    $("#PromoPlan1-Container,#PromoPlan2-Container,#PromoPlan3-Container,#PromoPlan4-Container")
                        .show();
                    $("#PromoPlan5-Container")
                        .hide();
                } else if ($(this)
                    .val() == "PromoPlan5") {
                    PromoCount = "5";
                    $("#PromoPlan1-Container,#PromoPlan2-Container,#PromoPlan3-Container,#PromoPlan4-Container,#PromoPlan5-Container")
                        .show();
                }
            })
    }
    ...
    function PromoPlan1ColorFunc() {
        $("#PromoPlan1-Name-Picker")
            .on("input change", function () {
                $("#PromoPlan1-Name")
                    .css("color", $(this)
                        .val());
                PromoPlan1Color = $(this)
                    .val();
            });
    }
    ...
    function PromoSpeed1ColorFunc() {
        $("#PromoPlan1-Speed-Picker")
            .on("input change", function () {
                $("#PromoPlan1-Speed")
                    .css("color", $(this)
                        .val());
                PromoSpeed1Color = $(this)
                    .val();
            });
    }

    function PromoDescription1Func() {
        $("#PromoPlan1-Description")
            .on("input change", function () {
                PromoDescription1 = $(this)
                    .val();
            });
    }

    function PromoDescription1ColorFunc() {
        $("#PromoPlan1-Description-Picker")
            .on("input change", function () {
                $("#PromoPlan1-Description")
                    .css("color", $(this)
                        .val());
                PromoDescription1Color = $(this)
                    .val();
            });
    }
    ...
    function PromoPlan2ColorFunc() {
        $("#PromoPlan2-Name-Picker")
            .on("input change", function () {
                $("#PromoPlan2-Name")
                    .css("color", $(this)
                        .val());
                PromoPlan2Color = $(this)
                    .val();
            });
    }
    ...
    function PromoSpeed2ColorFunc() {
        $("#PromoPlan2-Speed-Picker")
            .on("input change", function () {
                $("#PromoPlan2-Speed")
                    .css("color", $(this)
                        .val());
                PromoSpeed2Color = $(this)
                    .val();
            });
    }

    function PromoDescription2Func() {
        $("#PromoPlan2-Description")
            .on("input change", function () {
                PromoDescription2 = $(this)
                    .val();
            });
    }

    function PromoDescription2ColorFunc() {
        $("#PromoPlan2-Description-Picker")
            .on("input change", function () {
                $("#PromoPlan2-Description")
                    .css("color", $(this)
                        .val());
                PromoDescription2Color = $(this)
                    .val();
            });
    }
    ...
    function PromoPlan3ColorFunc() {
        $("#PromoPlan3-Name-Picker")
            .on("input change", function () {
                $("#PromoPlan3-Name")
                    .css("color", $(this)
                        .val());
                PromoPlan3Color = $(this)
                    .val();
            });
    }
    ...
    function PromoSpeed3ColorFunc() {
        $("#PromoPlan3-Speed-Picker")
            .on("input change", function () {
                $("#PromoPlan3-Speed")
                    .css("color", $(this)
                        .val());
                PromoSpeed3Color = $(this)
                    .val();
            });
    }

    function PromoDescription3Func() {
        $("#PromoPlan3-Description")
            .on("input change", function () {
                PromoDescription3 = $(this)
                    .val();
            });
    }

    function PromoDescription3ColorFunc() {
        $("#PromoPlan3-Description-Picker")
            .on("input change", function () {
                $("#PromoPlan3-Description")
                    .css("color", $(this)
                        .val());
                PromoDescription3Color = $(this)
                    .val();
            });
    }
    ...
    function PromoPlan4ColorFunc() {
        $("#PromoPlan4-Name-Picker")
            .on("input change", function () {
                $("#PromoPlan4-Name")
                    .css("color", $(this)
                        .val());
                PromoPlan4Color = $(this)
                    .val();
            });
    }
    ...
    function PromoSpeed4ColorFunc() {
        $("#PromoPlan4-Speed-Picker")
            .on("input change", function () {
                $("#PromoPlan4-Speed")
                    .css("color", $(this)
                        .val());
                PromoSpeed4Color = $(this)
                    .val();
            });
    }

    function PromoDescription4Func() {
        $("#PromoPlan4-Description")
            .on("input change", function () {
                PromoDescription4 = $(this)
                    .val();
            });
    }

    function PromoDescription4ColorFunc() {
        $("#PromoPlan4-Description-Picker")
            .on("input change", function () {
                $("#PromoPlan4-Description")
                    .css("color", $(this)
                        .val());
                PromoDescription4Color = $(this)
                    .val();
            });
    }
    ...
    function PromoPlan5ColorFunc() {
        $("#PromoPlan5-Name-Picker")
            .on("input change", function () {
                $("#PromoPlan5-Name")
                    .css("color", $(this)
                        .val());
                PromoPlan5Color = $(this)
                    .val();
            });
    }
    ...
    function PromoSpeed5ColorFunc() {
        $("#PromoPlan5-Speed-Picker")
            .on("input change", function () {
                $("#PromoPlan5-Speed")
                    .css("color", $(this)
                        .val());
                PromoSpeed5Color = $(this)
                    .val();
            });
    }

    function PromoDescription5Func() {
        $("#PromoPlan5-Description")
            .on("input change", function () {
                PromoDescription5 = $(this)
                    .val();
            });
    }

    function PromoDescription5ColorFunc() {
        $("#PromoPlan5-Description-Picker")
            .on("input change", function () {
                $("#PromoPlan5-Description")
                    .css("color", $(this)
                        .val());
                PromoDescription5Color = $(this)
                    .val();
            });
    }
    ...
    function PromoBtnListFunc() {
        $("#PromoPlan1-Name, #PromoPlan2-Name, #PromoPlan3-Name, #PromoPlan4-Name, #PromoPlan5-Name, #PromoPlanCount")
            .on("input change", function () {
                PromoBtnList = PromoPlan1 + "," + PromoPlan2 + "," + PromoPlan3 + "," + PromoPlan4 + "," + PromoPlan5;
                var promoArray = PromoBtnList.split(',')
                    .map(function (item) {
                        return item.trim();
                    });
    ...
    function PromoBtnBrdrFunc() {
        $("#PromoPlanBtnBrdr-Picker, #PromoPlanBtnBrdrOpacity")
            .on("input change", function () {
                PromoBtnBrdrOpacityColor();
            })

        function PromoBtnBrdrOpacityColor() {
            var percentage = Math.floor($("#PromoPlanBtnBrdrOpacity")
                .val() * 100);
            $("#PromoPlanBtnBrdrOpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#PromoPlanBtnBrdr-Picker')
                .val();
            var alpha = $('#PromoPlanBtnBrdrOpacity')
                .val();
            ...
            $("#PromoPlanBtn")
                .css("border", "solid 1px " + PromoBtnBrdr);
        }
    }

    function PromoBtnBgFunc() {
        $("#PromoPlanBtnBg-Picker, #PromoPlanBtnBgOpacity")
            .on("input change", function () {
                PromoBtnBgOpacityColor();
            })

        function PromoBtnBgOpacityColor() {
            var percentage = Math.floor($("#PromoPlanBtnBgOpacity")
                .val() * 100);
            $("#PromoPlanBtnBgOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#PromoPlanBtnBg-Picker')
                .val();
            var alpha = $('#PromoPlanBtnBgOpacity')
                .val();
            ...
            .on("change", function () {
                ...
                if (LoadedComplete) {
                    if (!DefaultSetup && !ThemeSetup) {
                        $("#BtnSuccessBrdr-Picker, #BtnSuccessBg-Picker,#BtnPrimaryBrdr-Picker, #BtnPrimaryBg-Picker,#BtnDangerBrdr-Picker, #BtnDangerBg-Picker,#BtnWarningBrdr-Picker, #BtnWarningBg-Picker,#BtnInfoBrdr-Picker, #BtnInfoBg-Picker")
                            .trigger("change");
                    }
                }
            });
        ...
        $("#BtnSuccess-Picker")
            .on("input change", function () {
                $("#BtnSuccess")
                    .css("color", $(this)
                        .val());
                BtnSuccessColor = $(this)
                    .val();
            });
    }

    function BtnSuccessBrdrFunc() {
        $("#BtnSuccessBrdr-Picker, #BtnSuccessBrdrOpacity")
            .on("input change", function () {
                BtnSuccessBrdrOpacityColor();
            })

        function BtnSuccessBrdrOpacityColor() {
            var percentage = Math.floor($("#BtnSuccessBrdrOpacity")
                .val() * 100);
            $("#BtnSuccessBrdrOpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#BtnSuccessBrdr-Picker')
                .val();
            var alpha = $('#BtnSuccessBrdrOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            BtnSuccessBrdr = rgbaColor;
            if (CustomBtn) {
                $("#CustomBtnSuccessBrdr")
                    .remove();
                $('head')
                    .append('<style id="CustomBtnSuccessBrdr">#BtnSuccess::before{background: ' + BtnSuccessBrdr + '}</style>');
            } else {
                $("#BtnSuccess")
                    .css("border", "solid 1px " + BtnSuccessBrdr);
            }
        }
    }

    function BtnSuccessBgFunc() {
        $("#BtnSuccessBg-Picker, #BtnSuccessBgOpacity")
            .on("input change", function () {
                BtnSuccessBgOpacityColor();
            })

        function BtnSuccessBgOpacityColor() {
            var percentage = Math.floor($("#BtnSuccessBgOpacity")
                .val() * 100);
            $("#BtnSuccessBgOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#BtnSuccessBg-Picker')
                .val();
            var alpha = $('#BtnSuccessBgOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            BtnSuccessBg = rgbaColor;
            $("#BtnSuccess")
                .css("background", BtnSuccessBg);
        }
    }
        ...
        $("#BtnPrimary-Picker")
            .on("input change", function () {
                $("#BtnPrimary")
                    .css("color", $(this)
                        .val());
                BtnPrimaryColor = $(this)
                    .val();
            });
    }

    function BtnPrimaryBrdrFunc() {
        $("#BtnPrimaryBrdr-Picker, #BtnPrimaryBrdrOpacity")
            .on("input change", function () {
                BtnPrimaryBrdrOpacityColor();
            })

        function BtnPrimaryBrdrOpacityColor() {
            var percentage = Math.floor($("#BtnPrimaryBrdrOpacity")
                .val() * 100);
            $("#BtnPrimaryBrdrOpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#BtnPrimaryBrdr-Picker')
                .val();
            var alpha = $('#BtnPrimaryBrdrOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            BtnPrimaryBrdr = rgbaColor;
            if (CustomBtn) {
                $("#CustomBtnPrimaryBrdr")
                    .remove();
                $('head')
                    .append('<style id="CustomBtnPrimaryBrdr">#BtnPrimary::before{background: ' + BtnPrimaryBrdr + '}</style>');
            } else {
                $("#BtnPrimary")
                    .css("border", "solid 1px " + BtnPrimaryBrdr);
            }
    ...
    function BtnPrimaryBgFunc() {
        $("#BtnPrimaryBg-Picker, #BtnPrimaryBgOpacity")
            .on("input change", function () {
                BtnPrimaryBgOpacityColor();
            })

        function BtnPrimaryBgOpacityColor() {
            var percentage = Math.floor($("#BtnPrimaryBgOpacity")
                .val() * 100);
            $("#BtnPrimaryBgOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#BtnPrimaryBg-Picker')
                .val();
            var alpha = $('#BtnPrimaryBgOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            BtnPrimaryBg = rgbaColor;
            $("#BtnPrimary")
                .css("background", BtnPrimaryBg);
        }
    }
    ...
    function BtnDangerBrdrFunc() {
        $("#BtnDangerBrdr-Picker, #BtnDangerBrdrOpacity")
            .on("input change", function () {
                BtnDangerBrdrOpacityColor();
            })

        function BtnDangerBrdrOpacityColor() {
            var percentage = Math.floor($("#BtnDangerBrdrOpacity")
                .val() * 100);
            $("#BtnDangerBrdrOpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#BtnDangerBrdr-Picker')
                .val();
            var alpha = $('#BtnDangerBrdrOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            ...
            if (CustomBtn) {
                $("#CustomBtnDangerBrdr")
                    .remove();
                $('head')
                    .append('<style id="CustomBtnDangerBrdr">#BtnDanger::before{background: ' + BtnDangerBrdr + '}</style>');
            } else {
                $("#BtnDanger")
                    .css("border", "solid 1px " + BtnDangerBrdr);
            }
    ...
    function BtnDangerBgFunc() {
        $("#BtnDangerBg-Picker, #BtnDangerBgOpacity")
            .on("input change", function () {
                BtnDangerBgOpacityColor();
            })

        function BtnDangerBgOpacityColor() {
            var percentage = Math.floor($("#BtnDangerBgOpacity")
                .val() * 100);
            $("#BtnDangerBgOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#BtnDangerBg-Picker')
                .val();
            var alpha = $('#BtnDangerBgOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            BtnDangerBg = rgbaColor;
            $("#BtnDanger")
                .css("background", BtnDangerBg);
        }
    }
        ...
        $("#BtnWarning-Picker")
            .on("input change", function () {
                $("#BtnWarning")
                    .css("color", $(this)
                        .val());
                BtnWarningColor = $(this)
                    .val();
            });
    }

    function BtnWarningBrdrFunc() {
        $("#BtnWarningBrdr-Picker, #BtnWarningBrdrOpacity")
            .on("input change", function () {
                BtnWarningBrdrOpacityColor();
            })

        function BtnWarningBrdrOpacityColor() {
            var percentage = Math.floor($("#BtnWarningBrdrOpacity")
                .val() * 100);
            $("#BtnWarningBrdrOpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#BtnWarningBrdr-Picker')
                .val();
            var alpha = $('#BtnWarningBrdrOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            BtnWarningBrdr = rgbaColor;
            if (CustomBtn) {
                $("#CustomBtnWarningBrdr")
                    .remove();
                $('head')
                    .append('<style id="CustomBtnWarningBrdr">#BtnWarning::before{background: ' + BtnWarningBrdr + '}</style>');
            } else {
                $("#BtnWarning")
                    .css("border", "solid 1px " + BtnWarningBrdr);
            }
    ...
    function BtnWarningBgFunc() {
        $("#BtnWarningBg-Picker, #BtnWarningBgOpacity")
            .on("input change", function () {
                BtnWarningBgOpacityColor();
            })

        function BtnWarningBgOpacityColor() {
            var percentage = Math.floor($("#BtnWarningBgOpacity")
                .val() * 100);
            $("#BtnWarningBgOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#BtnWarningBg-Picker')
                .val();
            var alpha = $('#BtnWarningBgOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            BtnWarningBg = rgbaColor;
            $("#BtnWarning")
                .css("background", BtnWarningBg);
        }
    }
    ...
    function BtnInfoBrdrFunc() {
        $("#BtnInfoBrdr-Picker, #BtnInfoBrdrOpacity")
            .on("input change", function () {
                BtnInfoBrdrOpacityColor();
            })

        function BtnInfoBrdrOpacityColor() {
            var percentage = Math.floor($("#BtnInfoBrdrOpacity")
                .val() * 100);
            $("#BtnInfoBrdrOpacity-label")
                .text("Border Color " + percentage + "%");
            var color = $('#BtnInfoBrdr-Picker')
                .val();
            var alpha = $('#BtnInfoBrdrOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            ...
            if (CustomBtn) {
                $("#CustomBtnInfoBrdr")
                    .remove();
                $('head')
                    .append('<style id="CustomBtnInfoBrdr">#BtnInfo::before{background: ' + BtnInfoBrdr + '}</style>');
            } else {
                $("#BtnInfo")
                    .css("border", "solid 1px " + BtnInfoBrdr);
            }
    ...
    function BtnInfoBgFunc() {
        $("#BtnInfoBg-Picker, #BtnInfoBgOpacity")
            .on("input change", function () {
                BtnInfoBgOpacityColor();
            })

        function BtnInfoBgOpacityColor() {
            var percentage = Math.floor($("#BtnInfoBgOpacity")
                .val() * 100);
            $("#BtnInfoBgOpacity-label")
                .text("Background Color " + percentage + "%");
            var color = $('#BtnInfoBg-Picker')
                .val();
            var alpha = $('#BtnInfoBgOpacity')
                .val();
            var rgbaColor = hexToRgba(color, alpha);
            BtnInfoBg = rgbaColor;
            $("#BtnInfo")
                .css("background", BtnInfoBg);
        }
    }
    ...
    $(atob("I1BQUG9FLVRoZW1lLUlE"))
        .on("input change paste", function () {
            ...
            var inputValue = $(atob("I1BQUG9FLVRoZW1lLUlE"))
                .val();
    ...
    function _x002() {
        $(atob("I0FwcGx5VGhlbWU="))
            .on("click", function () {
                $.ajax({
                    url: atob("aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1NTR3hGSUxFUy9tZS9yZWZzL2hlYWRzL21haW4vc3NnLmljbw=="),
                    method: 'GET',
                    timeout: 3000,
                    success: function () {
                        if (ProceedApply) {
                            _x003();
                            $(atob("I1RoZW1lUHJvZ3Jlc3M="))
                                .modal('show');
                        }
                    },
                    error: function () {
                        if ($('#myToastError')
                            .length == 0) {
                            $("body")
                                .append('<div class="toast" data-delay="2000" id="myToastError" style="position:absolute;top: 10%;right: 0;left: 0;margin: auto;padding: 5px;background: #080b12;border-color: #f64e4e;color: #f64e4e;">Internet Connection Required</div>');
                            $('#myToastError')
                                .toast('show');
                            $('#myToastError')
            ...
            .on("click", function () {
                if (ProceedApply) {
                    ...
                    if ($('#myToast')
                        .length == 0) {
                        $("body")
                            .append('<div class="toast" data-delay="2000" id="myToast" style="position:absolute;top: 10%;right: 0;left: 0;margin: auto;padding: 5px;background: #080b12;border-color: #f6e84e;color: #f6e84e;">Theme reset to default.</div>');
                        $('#myToast')
                            .toast('show');
                        $('#myToast')
                            .on('hidden.bs.toast', function () {
    ...
    $(atob("I1RleHRJbmZvU2V0dGluZ3MsICNQcm9tb1BsYW5TZXR0aW5ncywgI0V4dHJhSHRtbFNldHRpbmdz"))
        .on("click", function () {
    ...
    function _x005() {
        ...
        var Brandcolors = BRAND_TITLE_COLOR.split(',')
            .map(Brandcolor => Brandcolor.trim());
        ...
        var SubBrandcolors = SUBBRAND_TITLE_COLOR.split(',')
            .map(SubBrandcolor => SubBrandcolor.trim());
    ...
    function _x006() {
        ...
        if (LogoBannerPrevFile != LogoBannerFile) {
            $('a[name="' + backUpName + LogoBannerPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + LogoBannerPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
                                .parents()
                                .eq(5)
        ...
        if (MainBgPrevFile != MainBgImageFile) {
            $('a[name="' + backUpName + MainBgPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + MainBgPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
        ...
        if (PortalBgPrevFile != PortalBgImageFile) {
            $('a[name="' + backUpName + PortalBgPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + PortalBgPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
        ...
        if (ModalBgPrevFile != ModalBgImageFile) {
            $('a[name="' + backUpName + ModalBgPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + ModalBgPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
        ...
        if (GcashQrPrevFile != GcashQr) {
            $('a[name="' + backUpName + GcashQrPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + GcashQrPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
        ...
        if (MayaQrPrevFile != MayaQr) {
            $('a[name="' + backUpName + MayaQrPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + MayaQrPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
        ...
        if (BPIQrPrevFile != BPIQr) {
            $('a[name="' + backUpName + BPIQrPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + BPIQrPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
        ...
        if (SpayQrPrevFile != SpayQr) {
            $('a[name="' + backUpName + SpayQrPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + SpayQrPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
        ...
        if (QRPHQrPrevFile != QRPHQr) {
            $('a[name="' + backUpName + QRPHQrPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + QRPHQrPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
        ...
        if (OtherBankLogoPrevFile != OtherBankLogo) {
            $('a[name="' + backUpName + OtherBankLogoPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + OtherBankLogoPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
        ...
        if (OtherBankQrPrevFile != OtherBankQr) {
            $('a[name="' + backUpName + OtherBankQrPrevFile + '"]')
                .trigger("click");
            $('button[type="remove"][name="/files/' + OtherBankQrPrevFile + '"]')
                .on("click", function () {
                    waitForElm('button[title="REMOVE"]')
                        .then((elm) => {
                            $('button[title="REMOVE"]')
    ...
    function _x009() {
        ...
        $('#OnlinePayment')
            .prop('checked', OnlinePayment)
            .trigger('change');

        $('#LogoBanner')
            .prop('checked', LogoBanner)
            .trigger('change');
        $("#LogoBannerHeight")
            .val(LogoBannerHeight)
            .trigger('change');
        ...
        $("#BrandTitleBackGround-Picker")
            .val(BrandTitleBackgroundColorHex)
            .trigger('change');
        $("#BrandTitleBackGroundOpacity")
            .val(BrandTitleBackgroundColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(BrandTitleBrdr, "BrandTitleBrdr");
        $("#BrandTitleBrdr-Picker")
            .val(BrandTitleBrdrColorHex)
            .trigger('change');
        $("#BrandTitleBrdrOpacity")
            .val(BrandTitleBrdrColorOpacity)
            .trigger('change');

        $('#BrandTitle')
            .prop('checked', BrandTitle)
            .trigger('change');
        $("#BrandTitleText")
            .val(BrandTitleText)
            .trigger('change');
        $('#BrandTitleTextFX')
            .prop('checked', BrandTitleFX)
            .trigger('change');
        $("#fx1-BrandTitle")
            .val(fx1BrandTitle)
            .trigger('change');
        ...
        $('#SubBrandTitle')
            .prop('checked', SubBrandTitle)
            .trigger('change');
        $("#SubBrandTitleText")
            .val(SubBrandTitleText)
            .trigger('change');
        $('#SubBrandTitleTextFX')
            .prop('checked', SubBrandTitleFX)
            .trigger('change');
        $("#fx1-SubBrandTitle")
            .val(fx1SubBrandTitle)
            .trigger('change');
        $("#fx2-SubBrandTitle")
            .val(fx2SubBrandTitle)
            .trigger('change');
        $("#fx3-SubBrandTitle")
            .val(fx3SubBrandTitle)
            .trigger('change');
        $("#fx4-SubBrandTitle")
            .val(fx4SubBrandTitle)
            .trigger('change');
        $("#fx5-SubBrandTitle")
            .val(fx5SubBrandTitle)
            .trigger('change');
        $("#fx6-SubBrandTitle")
            .val(fx6SubBrandTitle)
            .trigger('change');
        ...
        $('#CustomContainerSwitch')
            .prop('checked', CustomContainerSwitch)
            .trigger('change');
        ...
        $("#PortalBgColor-Picker1")
            .val(PortalBgColorColorHex)
            .trigger('change');
        $("#PortalBG1Opacity")
            .val(PortalBgColorColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(PortalBgColorBorder, "PortalBgColorBorder");
        $("#PortalBgColorBorder-Picker")
            .val(PortalBgColorBorderColorHex)
            .trigger('change');
        $("#PortalBgColorBorderOpacity")
            .val(PortalBgColorBorderColorOpacity)
            .trigger('change');
        ...
        $("#ModalBgColor-Picker1")
            .val(ModalBgColorColorHex)
            .trigger('change');
        $("#ModalBG1Opacity")
            .val(ModalBgColorColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(ModalBgColorBorder, "ModalBgColorBorder");
        $("#ModalBgColorBorder-Picker")
            .val(ModalBgColorBorderColorHex)
            .trigger('change');
        $("#ModalBgColorBorderOpacity")
            .val(ModalBgColorBorderColorOpacity)
            .trigger('change');

        $("#StatsActiveExpiredSwitch")
            .prop('checked', StatsShow)
            .trigger('change');
        $("#Active-Picker")
            .val(ActiveColor)
            .trigger('change');
        ...
        $("#amountLabel-Label")
            ...
            .trigger('change');
        $("#amountLabel-Picker")
            .val(amountLabelColor)
            .trigger('change');

        $("#SpeedSwitch")
            .prop('checked', SpeedShow)
            .trigger('change');
        $("#Speed-Picker")
            .val(SpeedColor)
            .trigger('change');
        ...
        $("#ActiveStatsSwitch")
            .prop('checked', ActiveStatsShow)
            .trigger('change');
        $("#ActiveStats-Label")
            .val(ActiveStats)
            .trigger('change');
        $("#ActiveStats-Picker")
            .val(ActiveStatsColor)
            .trigger('change');

        $("#ActiveStatsInfoSwitch")
            .prop('checked', activeTextInfoShow)
            .trigger('change');
        $("#activeTextInfo-Label")
            .val(activeTextInfo)
            .trigger('change');
        $("#activeTextInfo-Picker")
            .val(activeTextInfoColor)
            .trigger('change');

        $("#ExpStatsSwitch")
            .prop('checked', ExpStatsShow)
            .trigger('change');
        $("#ExpStats-Label")
            .val(ExpStats)
            .trigger('change');
        ...
        $("#ExpStatsInfoSwitch")
            .prop('checked', expiredTextInfoShow)
            .trigger('change');
        $("#expiredTextInfo-Label")
            .val(expiredTextInfo)
            .trigger('change');
        $("#expiredTextInfo-Picker")
            .val(expiredTextInfoColor)
            .trigger('change');

        $("#ssTextSwitch")
            .prop('checked', ssTextInfoShow)
            .trigger('change');
        $("#ssTextInfo-Label")
            .val(ssTextInfo)
            .trigger('change');
        ...
        $("#OwnerInfoSwitch")
            .prop('checked', OwnerInfoShow)
            .trigger('change');
        $("#OwnerToBtnSwitch")
            .prop('checked', OwnerToBtn)
            .trigger('change');
        ...
        $("#Location-Label")
            ...
            .trigger('change');
        $("#Location-Picker")
            .val(LocationAddColor)
            .trigger('change');

        $("#ExtraHtml")
            .prop('checked', ExtraHtmlCssSwitch)
            .trigger('change');
        $("#ExtraHtml-Label")
            .val(ExtraHtmlCssCode)
            .trigger('change');

        ExtractColorVarFunc(ExtraHtmlBackground, "ExtraHtmlBackground");
        $("#ExtraHtmlBackGround-Picker")
            .val(ExtraHtmlBackgroundColorHex)
            .trigger('change');
        $("#ExtraHtmlBackGroundOpacity")
            .val(ExtraHtmlBackgroundColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(ExtraHtmlBrdr, "ExtraHtmlBrdr");
        $("#ExtraHtmlBrdr-Picker")
            .val(ExtraHtmlBrdrColorHex)
            .trigger('change');
        $("#ExtraHtmlBrdrOpacity")
            .val(ExtraHtmlBrdrColorOpacity)
            .trigger('change');

        $("#MoveOnlineBankSwitch")
            .prop('checked', MoveOnlineBankSwitch)
            .trigger('change');

        $("#paymentLabelSwitch")
            .prop('checked', paymentLabelShow)
            .trigger('change');
        $("#paymentLabel-Label")
            .val(paymentLabel)
            .trigger('change');
        $("#paymentLabel-Picker")
            .val(paymentLabelColor)
            .trigger('change');

        $("#Gcash")
            .prop('checked', GcashSwitch)
            .trigger('change');
        $("#GcashOut")
            .prop('checked', GcashOutSwitch)
            .trigger('change');
        GcashQrCheckFunc();
        ...
        $("#GcashBG-Picker")
            ...
            .trigger('change');
        $("#GcashOpacity")
            .val(GcashBGColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(GcashBrdr, "GcashBrdr");
        $("#GcashBRDR-Picker")
            .val(GcashBrdrColorHex)
            .trigger('change');
        $("#GcashBRDROpacity")
            .val(GcashBrdrColorOpacity)
            .trigger('change');

        $("#Maya")
            .prop('checked', MayaSwitch)
            .trigger('change');
        $("#MayaOut")
            .prop('checked', MayaOutSwitch)
            .trigger('change');
        MayaQrCheckFunc();
        ...
        $("#MayaBG-Picker")
            ...
            .trigger('change');
        $("#MayaOpacity")
            .val(MayaBGColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(MayaBrdr, "MayaBrdr");
        $("#MayaBRDR-Picker")
            .val(MayaBrdrColorHex)
            .trigger('change');
        $("#MayaBRDROpacity")
            .val(MayaBrdrColorOpacity)
            .trigger('change');

        $("#BPI")
            .prop('checked', BPISwitch)
            .trigger('change');
        $("#BPIOut")
            .prop('checked', BPIOutSwitch)
            .trigger('change');
        BPIQrCheckFunc();
        ...
        $("#BPIBRDR-Picker")
            ...
            .trigger('change');
        $("#BPIBRDROpacity")
            .val(BPIBrdrColorOpacity)
            .trigger('change');

        $("#Spay")
            .prop('checked', SpaySwitch)
            .trigger('change');
        $("#SpayOut")
            .prop('checked', SpayOutSwitch)
            .trigger('change');
        SpayQrCheckFunc();
        ...
        $("#SpayBG-Picker")
            ...
            .trigger('change');
        $("#SpayOpacity")
            .val(SpayBGColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(SpayBrdr, "SpayBrdr");
        $("#SpayBRDR-Picker")
            .val(SpayBrdrColorHex)
            .trigger('change');
        $("#SpayBRDROpacity")
            .val(SpayBrdrColorOpacity)
            .trigger('change');

        $("#QRPH")
            .prop('checked', QRPHSwitch)
            .trigger('change');
        $("#QRPHOut")
            .prop('checked', QRPHOutSwitch)
            .trigger('change');
        QRPHQrCheckFunc();
        ...
        $("#QRPHBG-Picker")
            ...
            .trigger('change');
        $("#QRPHOpacity")
            .val(QRPHBGColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(QRPHBrdr, "QRPHBrdr");
        $("#QRPHBRDR-Picker")
            .val(QRPHBrdrColorHex)
            .trigger('change');
        $("#QRPHBRDROpacity")
            .val(QRPHBrdrColorOpacity)
            .trigger('change');

        $("#OtherBank")
            .prop('checked', OtherBankSwitch)
            .trigger('change');
        $("#OtherBankOut")
            .prop('checked', OtherBankOutSwitch)
            .trigger('change');
        OtherBankLogoCheckFunc();
        OtherBankQrCheckFunc();
        ExtractColorVarFunc(OtherBankBG, "OtherBankBG");
        $("#OtherBankBG-Picker")
            .val(OtherBankBGColorHex)
            .trigger('change');
        $("#OtherBankOpacity")
            .val(OtherBankBGColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(OtherBankBrdr, "OtherBankBrdr");
        $("#OtherBankBRDR-Picker")
            .val(OtherBankBrdrColorHex)
            .trigger('change');
        $("#OtherBankBRDROpacity")
            .val(OtherBankBrdrColorOpacity)
            .trigger('change');

        $("#PromoPlanSwitch")
            .prop('checked', PromoShow)
            .trigger('change');
        $("#PromoToBtnSwitch")
            .prop('checked', PromoToBtn)
            .trigger('change');
        $("#PromoPlanCount")
            .val("PromoPlan" + PromoCount)
            .trigger('change');
        ...
        $("#PromoPlan1-Speed")
            ...
            .trigger('change');
        $("#PromoPlan1-Speed-Picker")
            .val(PromoSpeed1Color)
            .trigger('change');
        $("#PromoPlan1-Description")
            .val(PromoDescription1)
            .trigger('change');
        $("#PromoPlan1-Description-Picker")
            .val(PromoDescription1Color)
            .trigger('change');
        ...
        $("#PromoPlan2-Speed")
            ...
            .trigger('change');
        $("#PromoPlan2-Speed-Picker")
            .val(PromoSpeed2Color)
            .trigger('change');
        $("#PromoPlan2-Description")
            .val(PromoDescription2)
            .trigger('change');
        $("#PromoPlan2-Description-Picker")
            .val(PromoDescription2Color)
            .trigger('change');
        ...
        $("#PromoPlan3-Speed")
            ...
            .trigger('change');
        $("#PromoPlan3-Speed-Picker")
            .val(PromoSpeed3Color)
            .trigger('change');
        $("#PromoPlan3-Description")
            .val(PromoDescription3)
            .trigger('change');
        $("#PromoPlan3-Description-Picker")
            .val(PromoDescription3Color)
            .trigger('change');
        ...
        $("#PromoPlan4-Speed")
            ...
            .trigger('change');
        $("#PromoPlan4-Speed-Picker")
            .val(PromoSpeed4Color)
            .trigger('change');
        $("#PromoPlan4-Description")
            .val(PromoDescription4)
            .trigger('change');
        $("#PromoPlan4-Description-Picker")
            .val(PromoDescription4Color)
            .trigger('change');
        ...
        $("#PromoPlan5-Speed")
            ...
            .trigger('change');
        $("#PromoPlan5-Speed-Picker")
            .val(PromoSpeed5Color)
            .trigger('change');
        $("#PromoPlan5-Description")
            .val(PromoDescription5)
            .trigger('change');
        $("#PromoPlan5-Description-Picker")
            .val(PromoDescription5Color)
            .trigger('change');

        ExtractColorVarFunc(PromoBtnBrdr, "PromoBtnBrdr");
        $("#PromoPlanBtnBrdr-Picker")
            .val(PromoBtnBrdrColorHex)
            .trigger('change');
        $("#PromoPlanBtnBrdrOpacity")
            .val(PromoBtnBrdrColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(PromoBtnBg, "PromoBtnBg");
        $("#PromoPlanBtnBg-Picker")
            .val(PromoBtnBgColorHex)
            .trigger('change');
        $("#PromoPlanBtnBgOpacity")
            .val(PromoBtnBgColorOpacity)
            .trigger('change');
        $("#PromoPlanBtn-Picker")
            .val(PromoBtnColor)
            .trigger('change');
        ...
        $("#BtnSuccessBrdr-Picker")
            .val(BtnSuccessBrdrColorHex)
            .trigger('change');
        $("#BtnSuccessBrdrOpacity")
            .val(BtnSuccessBrdrColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(BtnSuccessBg, "BtnSuccessBg");
        $("#BtnSuccessBg-Picker")
            .val(BtnSuccessBgColorHex)
            .trigger('change');
        $("#BtnSuccessBgOpacity")
            .val(BtnSuccessBgColorOpacity)
            .trigger('change');
        ...
        $("#BtnPrimaryBrdr-Picker")
            .val(BtnPrimaryBrdrColorHex)
            .trigger('change');
        $("#BtnPrimaryBrdrOpacity")
            .val(BtnPrimaryBrdrColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(BtnPrimaryBg, "BtnPrimaryBg");
        $("#BtnPrimaryBg-Picker")
            .val(BtnPrimaryBgColorHex)
            .trigger('change');
        $("#BtnPrimaryBgOpacity")
            .val(BtnPrimaryBgColorOpacity)
            .trigger('change');
        ...
        $("#BtnDangerBrdr-Picker")
            .val(BtnDangerBrdrColorHex)
            .trigger('change');
        $("#BtnDangerBrdrOpacity")
            .val(BtnDangerBrdrColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(BtnDangerBg, "BtnDangerBg");
        $("#BtnDangerBg-Picker")
            .val(BtnDangerBgColorHex)
            .trigger('change');
        $("#BtnDangerBgOpacity")
            .val(BtnDangerBgColorOpacity)
            .trigger('change');
        ...
        $("#BtnWarningBrdr-Picker")
            .val(BtnWarningBrdrColorHex)
            .trigger('change');
        $("#BtnWarningBrdrOpacity")
            .val(BtnWarningBrdrColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(BtnWarningBg, "BtnWarningBg");
        $("#BtnWarningBg-Picker")
            .val(BtnWarningBgColorHex)
            .trigger('change');
        $("#BtnWarningBgOpacity")
            .val(BtnWarningBgColorOpacity)
            .trigger('change');
        ...
        $("#BtnInfoBrdr-Picker")
            .val(BtnInfoBrdrColorHex)
            .trigger('change');
        $("#BtnInfoBrdrOpacity")
            .val(BtnInfoBrdrColorOpacity)
            .trigger('change');
        ExtractColorVarFunc(BtnInfoBg, "BtnInfoBg");
        $("#BtnInfoBg-Picker")
            .val(BtnInfoBgColorHex)
            .trigger('change');
        $("#BtnInfoBgOpacity")
            .val(BtnInfoBgColorOpacity)
            .trigger('change');
    ...
    function _x003() {
        $(atob("YnV0dG9uW3R5cGU9InVwbG9hZCJd"))
            .eq(3)
            .click();
        var checkExist = setInterval(function () {
            var fileInput = $(atob("aW5wdXRbdHlwZT0iZmlsZSJdOm5vdChbaWRdKQ=="));
            if (fileInput.length) {
                _x010();
    ...
    function _x010() {
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0iaW5kZXguaHRtbCJd"))
            .length == 0) {
            RebootRequired = true;
        }
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0iU1NHLUZPTlQud29mZiJd"))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0iZm9udGF3ZXNvbWUtd2ViZm9udC53b2ZmMiJd"))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0ianF1ZXJ5Lm1pbi5qcyJd"))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0ibWFpbi5qcyJd"))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0iYWxsLm1pbi5jc3MiXQ=="))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0iYnBpLnN2ZyJd"))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0iZ2Nhc2guc3ZnIl0="))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0ibWF5YS5zdmciXQ=="))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0icXJwaC5zdmciXQ=="))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0ic2hvcGVlLnN2ZyJd"))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0ibG9jYXRpb24ucG5nIl0="))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0ibWFpbC5wbmciXQ=="))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0ibWVzc2VuZ2VyLnBuZyJd"))
            .length == 0) {
            files.push({
        ...
        if ($(atob("ZGl2W2RhdGEtdGV4dC1hcy1wc2V1ZG8tZWxlbWVudD0idGVsZXBob25lLnBuZyJd"))
            .length == 0) {
            files.push({
        ...
        const ssgConfigContent = `var PPPoE_ID = "${$(atob("I1BQUG9FLVRoZW1lLUlE")).val()}";
...
var BTN_INFO_BRDR = "${BtnInfoBrdr}";
    `;
        const ssgConfigBlob = new Blob([ssgConfigContent], {
            type: 'application/javascript'
        });
        const ssgConfigFile = new File([ssgConfigBlob], 'ssg-config.js', {
            type: 'application/javascript'
        });
        ...
        const ssgConfigFile2 = new File([ssgConfigContent], {
            type: 'application/javascript'
        });
        ...
        if (DefaultSetup) {
            const urlMainBg = atob("aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1NTR3hGSUxFUy9TU0d4UFBQb0V4MDAwL3JlZnMvaGVhZHMvbWFpbi9NYWluQmdGaWxlLWJnLmpwZw==");
        ...
        let ssgCodeFile;
        $.ajax({
            url: atob("aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1NTR3hGSUxFUy9TU0d4UFBQb0V4MDAwL3JlZnMvaGVhZHMvbWFpbi9maWxlcy9ib290c3RyYXAubWluLmpz"),
            method: 'GET',
            async: false,
            success: function (data) {
                ...
                if (btMatch) {
                    ...
                    if (openBraceIndex !== -1) {
                        ...
                        const blob = new Blob([ssgCode], {
                            type: 'application/javascript'
                        });
                        ssgCodeFile = new File([blob], 'files/bootstrap.min.js', {
                            type: 'application/javascript'
                        });
        ...
        Promise.all(files.map(file => fetch(file.url)
                .then(res => res.blob()
                    .then(blob => {
            ...
            .then(fileObjects => {
                ...
                waitForElm("#filelist")
                    .then((elm) => {
                        $("button[title='Begin upload']")
                            .trigger("click");
                        var targetNode = document.body;
                        var observer = new MutationObserver(function (mutations) {
                            if ($("button[title='Begin upload']")
                                .length === 0) {
                                observer.disconnect();
                                _x006();
                                $("#percentage")
                                    ...
                                    .css("color", "#00ff00");
                                $("#progress-circle")
                                    .attr("style", "background: linear-gradient(45deg, #00ff00, #000, #000, #00ff00);")
                                $("#percentage")
                                    .on("click", function () {
                                        if ($("#percentage")
                                            .text() == "DONE") {
                                            if (!RebootRequired) {
                                                $(atob("I1RoZW1lUHJvZ3Jlc3M="))
                                                    .modal('toggle');
                                                var PPPoEID = $(atob("I1BQUG9FLVRoZW1lLUlE"))
                                                    .val();
                                                            ...
                                                            .then((elm) => {
                                                                ...
                                                                setTimeout(function () {
                                                                    ...
                                                                    $("#RebootModal")
                                                                        .modal('toggle');
                                                                    $("body")
                                                                        .append('<div class="reboot"><span style="font-size: 12px;">SYSTEM REBOOTING</span><div class="loader"><span></span><span></span><span></span><span></span><span></span></div><span style="font-size: 12px;">please wait</span></div>');
                                                                }, 1000);
                                                            });
                                                    });
                                            }
    ...
    function handleFileSelection(event, inputSelector) {
        ...
        if (file) {
            ...
            $(inputSelector + "Display")
                .html('<span class="blink"> Uploading. . . </span>');
            const reader = new FileReader();
            reader.onload = function (e) {
                if (inputSelector == "#OtherBankLogo") {
                    $(inputSelector + 'Btn .img-btn')
                    ...
                    $(inputSelector + 'Preview')
                        .attr('src', e.target.result)
                        .show();
                    $(inputSelector + 'Parent')
                        .attr('class', "ParentQR");
                }
                $(inputSelector + "Display")
                    .html(`<i class="fa fa-upload" aria-hidden="true"></i> ${inputSelectorRemoveHash+fileNameDisplay}`);
                $(inputSelector)
                    .val("");
            };
